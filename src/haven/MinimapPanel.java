...
public class MinimapPanel extends Window {
	...
	public MinimapPanel(Coord c, Coord sz, Widget parent) {
		...
		{
			new IButton(new Coord(0, -2), this, Resource.loadimg("gfx/hud/slen/dispauth"),
		...
		{
			new IButton(new Coord(0, 4), this, Resource.loadimg("gfx/hud/slen/dispclaim"),
		...
		new IButton(new Coord(42, 8), this, Resource.loadimg("gfx/hud/buttons/gridu"),
		...
		new IButton(new Coord(62, 8), this, Resource.loadimg("gfx/hud/buttons/centeru"),
		...
		new IButton(new Coord(83, 8), this, Resource.loadimg("gfx/hud/buttons/simpleu"),
		...
		new IButton(new Coord(103, 2), this, Resource.loadimg("gfx/hud/charsh/plusup"),
		...
		new IButton(new Coord(103, 16), this, Resource.loadimg("gfx/hud/charsh/minusup"),
		...
		btncave = new IButton(new Coord(121, 8), this, Resource.loadimg("gfx/hud/buttons/saveu"),
