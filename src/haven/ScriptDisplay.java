...
public class ScriptDisplay extends Window {
	...
	public ScriptDisplay(Coord c, Widget parent) {
		...
		run = new Button(new Coord(5, 290), 120, this, "Run") {
			public void click() {
				runScript();
			}
		};
		stop = new Button(new Coord(140, 290), 120, this, "Stop") {
			public void click() {
				ui.m_util.stop(1);
			}
		};
		forceStop = new Button(new Coord(275, 290), 120, this, "Force Stop") {
			public void click() {
				ui.m_util.forceStop();
			}
		};

		new Button(new Coord(5, 325), 60, this, "Compile") {
			public void click() {
				AutoCompilation.compile();
			}
		};
		new Button(new Coord(80, 325), 60, this, "Update") {
			public void click() {
		...
		new IButton(new Coord(195, 320), this, charUp[0], charUp[1]) {
			public void click() {
				iconNum++;
				if (iconNum > 16)
					iconNum = 0;
		...
		new IButton(new Coord(195, 335), this, charDown[0], charDown[1]) {
			public void click() {
				iconNum--;
				if (iconNum < 0)
					iconNum = 16;
	...
	String scriptToString() {
		...
		try {
			if (o == -1)
				o = Integer.parseInt(option.text);
		} catch (Exception e) {
		}
