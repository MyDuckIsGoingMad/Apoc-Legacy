...
public class CharWnd extends Window {
	...
	public static final RichText.Foundry skbodfnd = new RichText.Foundry(TextAttribute.FAMILY, "SansSerif",
			TextAttribute.SIZE, 9);
	...
	class Belief extends Attr {
		...
		Belief(String nm, String left, String right, boolean inv, int x, int y) {
			...
			this.inv = inv;
			lx = x;
			Label lbl = new Label(new Coord(x, y), belief,
					String.format("%s / %s", Utils.titlecase(left), Utils.titlecase(right)));
	...
	class SAttr extends NAttr {
		...
		SAttr(String nm, int x, int y) {
			...
			tvalb = attr.base;
			tvalc = attr.comp;
			minus = new IButton(new Coord(x + 30, y), cattr, Resource.loadimg("gfx/hud/charsh/minusup"),
			...
			plus = new IButton(new Coord(x + 45, y), cattr, Resource.loadimg("gfx/hud/charsh/plusup"),
	...
	public CharWnd(Coord c, Widget parent, int studyid) {
		...
		int bx = 10;
		new IButton(new Coord(bx, 310), this, Resource.loadimg("gfx/hud/charsh/attribup"),
		...
		if (studyid >= 0) {
			new IButton(new Coord(bx += 70, 310), this, Resource.loadimg("gfx/hud/charsh/ideasup"),
		...
		new IButton(new Coord(bx += 70, 310), this, Resource.loadimg("gfx/hud/charsh/skillsup"),
		...
		new IButton(new Coord(bx += 70, 310), this, Resource.loadimg("gfx/hud/charsh/worshipup"),
