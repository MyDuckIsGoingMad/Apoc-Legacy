...
public class BuddyWnd extends Window {
	...
	public BuddyWnd(Coord c, Widget parent) {
		...
		sbstatus = new Button(new Coord(200, 305), 60, this, "Status") {
			public void click() {
				setcmp(statuscmp);
			}
		};
		sbgroup = new Button(new Coord(265, 305), 60, this, "Group") {
			public void click() {
				setcmp(groupcmp);
			}
		};
		sbalpha = new Button(new Coord(330, 305), 60, this, "Alphabet") {
			public void click() {
				setcmp(alphacmp);
			}
		};
		...
		new Button(new Coord(0, 365), 50, this, "Set") {
			public void click() {
				sendpwd(charpass.text);
			}
		};
		new Button(new Coord(60, 365), 50, this, "Clear") {
			public void click() {
				sendpwd("");
			}
		};
		new Button(new Coord(120, 365), 50, this, "Random") {
			public void click() {
				sendpwd(randpwd());
			}
		};
